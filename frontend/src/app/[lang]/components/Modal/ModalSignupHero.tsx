  ...
  return (
    <div className="modal-signup">
      ...
      <GoogleCaptchaWrapper Google_reCaptcha_Site_key={Google_reCaptcha_Site_key}>
        <SignUpHero data={data} formId={"modal"} onClickModalClose={onClickClose} lang={lang} />
        </GoogleCaptchaWrapper>
      </div>
    </div>
  );
};
const ModalSignupHero = ({ data, onClickClose  ,lang,Google_reCaptcha_Site_key}: ModalSignupProps) => {
...
export default ModalSignupHero;
